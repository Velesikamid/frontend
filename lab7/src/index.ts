...
car2.printInfo();
let car3: Car = new Car("mclaren", "senna", "2013", "a", "b", owner, bodyTypes.SUPERCAR, carClasses.A);
car3.printInfo();
...
let storage2: VehicleStorage<Car> = new VehicleStorage([car1, car2, car3]);
...
console.log(storage2.sortByModel());

console.log(storage2.getAllVehiclesWithMark("MCLAREN"));
